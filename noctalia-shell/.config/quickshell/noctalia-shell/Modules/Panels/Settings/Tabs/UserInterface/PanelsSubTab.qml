...
ColumnLayout {
  ...
  NToggle {
    label: I18n.tr("panels.user-interface.hover-widget-wheel-control-label")
    description: I18n.tr("panels.user-interface.hover-widget-wheel-control-description")
    checked: Settings.data.general.allowHoverWidgetWheelControl
    defaultValue: Settings.getDefaultValue("general.allowHoverWidgetWheelControl")
    onToggled: checked => Settings.data.general.allowHoverWidgetWheelControl = checked
  }
